...
from oarsigrading.metadata.utils import load_landmarks
from oarsigrading.metadata.oai import get_oai_meta
from oarsigrading.metadata.most import get_most_meta


def read_images_and_metadata(args, img_dir_name='MOST_OAI_FULL_0_2'):
